...
to setup
  ...
  ask patches [
    ...
    if random 100 < 40 [
      set pcolor green ;; dreen cells are alive
    ]
  ]
  reset-ticks
end
...
to go
  ...
  ask patches [
    ;; patches within 3 green neighbors, turn (or stay ) green
    ...
    ;; patches iwth 4 or more green neighbors turn (or stay) dark blue
    ;; (from overcowding)
