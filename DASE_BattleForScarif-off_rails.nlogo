...
globals [
  ...
  shield-gate-health          ;; Health of the shield gate
...
to setup-imperials
  ...
  create-imperials imperial-troop-deployment [
    ...
    set role "trooper"
    set health 100
    set armor 5                    ;; resiliency variable
    set shield 30                  ;; resiliency variable
    set shield-max 30              ;; resiliency variable
    set shield-recharge-rate .5    ;; resiliency variable
  ...
  create-ships imperial-spacecraft-deployment [
    ...
    set health 100
    set armor 20                    ;; resiliency variable
    set shield 100                  ;; resiliency variable
    set shield-max 100              ;; resiliency variable
    set shield-recharge-rate 2      ;; resiliency variable
...
to setup-rebels
  ...
  create-rebels rebel-ground-troop-numbers [
    ...
    assign-rebel-role
    set health 100
    set armor 10                 ;; resiliency variable
    set shield 50                 ;; resiliency variable
    set shield-max 50             ;; resiliency variable
    set shield-recharge-rate 1    ;; resiliency variable
    set shield-gate? false  ;; initialize to false
  ]
...
to attempt-attack-shield-gate
  ask rebels [
    ;; olny ships can attack the shield gate
    if breed = ships [
      ;; check if near the shield gate
...
to reduce-shield-gate-health [damage]
  set shield-gate-health shield-gate-health - damage
  if shield-gate-health <= 0 [
    set shield-gate-health 0
    set shield-gate-status "Destroyed"
    user-message "Rebels have destroyed the Shield Gate!"
    update-shield-gate-appearance
  ] if shield-gate-health <= 40 and shield-gate-status != "Vulnerable" [
    set shield-gate-status "Vulnerable"
    user-message "Shield Gate is now Vulnerable!"
    update-shield-gate-appearance
  ] if shield-gate-health <= 70 and shield-gate-status = "Fully Operational" [
    set shield-gate-status "Reduced Efficiency"
    user-message "Shield Gate efficiency has been reduced!"
    update-shield-gate-appearance
  ]
  update-shield-gate-label
end
